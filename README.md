...
## Источники
Работа с авторизацией через яндекс паспорт организована согласно [инструкции](https://yandex.ru/dev/id/doc/ru/codes/code-and-token)

Работа с API яндекс музыки снована на [неофициальной документации](https://github.com/acherkashin/yandex-music-open-api) (в последнее время отвечает на все запросы капчей, в связи с чем приложение временно не работает)
