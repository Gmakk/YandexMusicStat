...
//    }
    ...
    public static boolean getToken(){
        //TODO: QR-код?
        System.out.println("Please follow the link and enter the confirmation code:\n" +
        ...
        try {
            ...
            String postResult = Request.Post("https://oauth.yandex.ru/token")
                    ...
                    .bodyForm(Form.form()
                            .add("code", Integer.toString(confirmationCode)).add("grant_type", "authorization_code")
                            .build())
                    .execute().returnContent().toString();
            ...
            Gson gson = new GsonBuilder()
                    ...
                    .create();
            gson.fromJson(postResult, Token.class);


            System.out.println(postResult);
            System.out.println(Token.getToken().substring(3));
